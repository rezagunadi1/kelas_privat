...
<div class="mx-auto mt-4 mb-3">
    ...
    <div class="mt-2 text-left fs-5">
        ...
        <br>
        <br>
        Aplikasi Child Care dimiliki oleh kelas-privat.com, yang akan menjadi pengontrol atas data pribadi Anda.
        <br>
        Kami telah mengadopsi Kebijakan Privasi ini untuk menjelaskan bagaimana kami memproses informasi yang dikumpulkan oleh Child Care, yang juga menjelaskan alasan mengapa kami perlu mengumpulkan data pribadi tertentu tentang Anda. Oleh karena itu, Anda harus membaca Kebijakan Privasi ini sebelum menggunakan aplikasi Child Care.
        <br>
        <br>
